...
$fanew = theme_lambda_get_setting('use_fa5');
        ...
        <div class="lambda-custom-menu container-fluid">
            <?php
                if ($home_button == 'shortname') {
                    ...
                    $home_button_string = '<a class="brand" href="'.$CFG->wwwroot.'/?redirect=0">'.$shortname.'</a>'; 
                }
                else if ($home_button == 'home') { 
                    $home_button_string = '<a class="brand" href="'.$CFG->wwwroot.'/?redirect=0">'.get_string('home').'</a>'; 
                }
                else if ($home_button == 'icon') {
                    if ($fanew) {
                        $home_button_string = '<a class="brand" href="'.$CFG->wwwroot.'/?redirect=0"><i class="fa-solid fa-house-chimney"></i></a>'; 
                    } else {
                        $home_button_string = '<a class="brand" href="'.$CFG->wwwroot.'/?redirect=0"><i class="fa fa-home"></i></a>'; 
                    }                    
                }
                else { // Fallback, should not happen
                    $home_button_string = '<a class="brand" href="'.$CFG->wwwroot.'/?redirect=0">'.$SITE->shortname.'</a>'; 
                }
