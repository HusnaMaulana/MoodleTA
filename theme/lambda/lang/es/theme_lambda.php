...
$string['section_0_open'] = 'Sección superior del curso siempre abierta';
$string['section_0_open_desc'] = 'Seleccione esta configuración si desea tener siempre abierta la sección superior del curso general. Con el formato de curso "Temas" o "Semanal", la sección superior de un curso ya no se puede contraer.';
...
$string['bs4_layout_files'] = 'Cargue los archivos de diseño de Bootstrap 4';
$string['bs4_layout_files_desc'] = 'Seleccione esta opción para habilitar la compatibilidad con el diseño de cuadrícula de Bootstrap 4. Esta configuración solo debe usarse si ha usado previamente un tema basado en Boost y su contenido creado ahora se muestra de manera diferente con Lambda que antes.';
...
$string['use_fa5_desc'] = 'Use los nuevos íconos de Font Awesome 6 Web Font.<br /><strong>Tenga en cuenta:</strong> Si ya tiene contenido con íconos de Font Awesome 4, tenga en cuenta que hay algunas diferencias con respecto a v4 que se deben tener en cuenta al usar v6. Si desea actualizar, asegúrese de leer el <a href="https://fontawesome.com/docs/web/setup/upgrade/upgrade-from-v4" target="_blank">tutorial de actualización</a>.<br />Para nuevos proyectos, se recomienda la última versión 6. ';
